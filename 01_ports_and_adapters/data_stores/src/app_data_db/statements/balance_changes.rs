pub const CREATE_TABLE_BALANCE_CHANGES: &str = "CREATE TABLE IF NOT EXISTS
    balance_changes (
...
pub const SELECT_BALANCE_CHANGES_BY_ACCOUNT: &str =
...
pub const SELECT_BALANCE_CHANGES_BY_TX_ID: &str =
    "SELECT * FROM balance_changes WHERE tx_id = ?";

pub const INSERT_BALANCE_CHANGE: &str = "INSERT OR REPLACE INTO
    balance_changes (
        id,
        account,
        resource,
