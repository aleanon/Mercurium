...
use iced::{futures::SinkExt, widget::shader::wgpu::naga::back, Subscription};
            ...
            |mut output| async move {
                ...
                loop {
                    ...
                    match action {
                        ...
                        Action::UpdateAccount(account_address) => {
                            backend
                                .action_update_account(account_address, &mut output)
                                .await
                        }
                        _ => {
