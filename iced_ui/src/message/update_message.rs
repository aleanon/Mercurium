...
use types::{
    accounts_and_resources, address::resource_address, assets::FungibleAsset, AccountsAndResources,
    AccountsUpdate, Action, EntityAccount, ResourceAddress,
};
...
impl<'a> Update {
    ...
    fn process_updated_accounts_and_resources(
        ...
        let download_icons = {
            ...
            Command::perform(
                async move {
                    handles::network::download::download_resize_and_store_resource_icons(
                        icon_urls, network,
                    )
                    .await
                },
