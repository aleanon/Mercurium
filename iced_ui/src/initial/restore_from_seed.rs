...
//         Task::perform(
//             async move {
//                 let icons = handles::image::download::download_resize_and_store_resource_icons_as_handle(
//                     icon_urls, network,
//                 )
//                 .await;
...
//             },
//             |result| match result {
//                 Ok(_) => AppMessage::TaskResponse(external_task_response::Message::Error(AppError::Fatal(String::new()))),
//                 Err(err) => {
...
//         let nav = nav_row(
//             nav_button("Back", Message::Back.into()),
//             nav_button("Next", Message::Next.into()),
//         );
