...
pub const IMAGE_STANDARD_WIDTH: u32 = 150;
pub const IMAGE_STANDARD_HEIGHT: u32 = 150;
...
pub fn fast_resize(
    ...
    resizer
        .resize(image, &mut dst_image, Some(&resize_options))
        .ok()?;
...
pub fn resize_big_dimensions(image: &DynamicImage) -> Option<Vec<u8>> {
    fast_resize(
        image,
        IMAGE_BIG_WIDTH,
        IMAGE_BIG_HEIGHT,
